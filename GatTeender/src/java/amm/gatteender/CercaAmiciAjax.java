 ...
 * @author F4briK
 */
public class CercaAmiciAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (command != null) 
        {
            ...
            if (command.equals("search")) 
            {
                ...
                // Esegue la ricerca
                List<Gatto> listaGatti = GattoFactory.getInstance()
                        .getGattiList(request.getParameter("nomeGattoCercato"));
                
                request.setAttribute("listaGatti", listaGatti);
                ...
                request.getRequestDispatcher("listaGattiJson.jsp").
